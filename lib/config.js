var ConfigLoader = (function() {
  ...
  ConfigLoader.prototype.loadEtcd = function(host, callback) {
    ...
    host = process.env.ETCO_HOST || host;
    var port = process.env.ETCO_PORT || 4001;
    ...
    this.etcdClient = new Etcd(host, port);
    var packageContents = require(this.rootPath + 'package.json');
    this.etcdPath = '/config/' + (process.env.ETCO_PACKAGE_NAME || packageContents.name);
    this.etcdClient.get(this.etcdPath, { maxRetries: 10 }, callback);
  };
